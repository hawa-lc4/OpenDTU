...
public:
    ...
    // void init(Scheduler& scheduler, const DisplayType_t type, const uint8_t data, const uint8_t clk, const uint8_t cs, const uint8_t reset, const uint8_t backlight); // hawa-lc4: append backlight
